<template lang="html">
  <div >
      ...
      <div class="container">
        <div class="checkout-addr">
          ...
          <div class="addr-list-wrap">
            <div class="addr-list">
              <ul>
                <li v-for="(item, index) in addressListFilter" :class="{'check': currentIndex === index }" @click="selectedAddress(index, item)">
                  <dl>
                    <dt>{{item.userName}}</dt>
                  ...
                  <div class="addr-opration addr-set-default">
                    <a href="javascript:;" class="addr-set-default-btn" @click="setDefaultAddress(item.addressId)" v-if="item.isDefault === false"><i>Set default</i></a>
                  </div>
          ...
          <div class="next-btn-wrap">
            <router-link class="btn btn--m btn--red" :to="{ path: 'orderConfirm', query: {'addressId': this.selectAddress} }">Next</router-link>
          </div>
        </div>
      </div>
    </div>
    <modal v-bind:mdShow="mdShow" v-on:close="closeModal">
      ...
      <div slot="btnGroup">
        <a href="javascipt:;" class="btn btn--m" @click="delAddress">确认</a>
  ...
  methods: {
    ...
    setDefaultAddress (addressId) {
      ...
      axios.post('/users/setDefaultAddress', {
        ...
        let res = response.data
        if (res.status === '0') {
          console.log('set defalut address suc')
          this.getAddress()
        }
      })
    },
